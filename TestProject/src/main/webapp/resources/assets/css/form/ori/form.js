...
(function (i, k) {
    function e(a) {
        function d(a, b) {
            ...
            return isNaN(a) || a <= 0 ? 0 : b < a ? d : a < 1 || 1 === b ? 1 === d ? a : a * d | 0 : a * d / b
        }

        function b(a, b, c) {
            function e(a, b, d) {
                d = ++d % 1;
                return 6 * d < 1 ? a + (b - a) * 6 * d : 2 * d < 1 ? b : 3 * d < 2 ? a + (b - a) * (4 - 6 * d) : a
            }
        ...
        function c(a, b, c) {
            var a = d(a, 360) / 60, b = d(b, 1), c = d(c, 1), e = a | 0, m = a - e, a = Math.round(255 * c * (1 - b)), j = Math.round(255 * c * (1 - b * m)), b = Math.round(255 * c * (1 - b * (1 - m))), c = Math.round(255 * c);
            switch (e) {
                case 1:
                    return [j, c, a];
                case 2:
            ...
            if ("number" === typeof a)this.a = (a >> 24 & 255) / 255, this.r = a >> 16 & 255, this.g = a >> 8 & 255, this.b = a & 255; else {
                for (; "object" === typeof a;) {
                    if (0 in a && 1 in a && 2 in a) {
                        ...
                        this.b = d(a[2]);
                        return
                    } else if ("r" in a && "g" in a && "b" in a) {
                        this.a = d(a.a, 1);
                        this.r = d(a.r);
                        this.g = d(a.g);
                        this.b = d(a.b);
                        return
                    } else if ("h" in a && "s" in a) {
                        var f;
        ...
        this.getCSS = function () {
            return this.c ? 0 === this.a ? "transparent" : 1 === this.a ? "rgb(" + this.r + "," + this.g + "," + this.b + ")" : p(this.r, this.g, this.b, this.a) : null
        };
        ...
        this.getName = function () {
            if (this.c) {
                var a = null, b, d = o, c = this.getHSL(), m;
                for (m in d) {
                    var j = (new e(d[m])).getHSL(), j = Math.sqrt(0.5 * (c.h - j.h) * (c.h - j.h) + 0.5 * (c.s - j.s) * (c.s - j.s) + (c.l - j.l) * (c.l - j.l));
                    if (null === a || j < a)a = j, b = m
                }
                return b
            }
            return null
        ...
        this.getHSL = function () {
            if (this.c) {
                var a = this.r / 255, b = this.g / 255, d = this.b / 255, c = Math.min(a, b, d), e = Math.max(a, b, d), j = e - c, i = (e + c) / 2;
                0 === j ? c = a = 0 : (a = a === e ? (b - d) / j : b === e ? 2 + (d - a) / j : 4 + (a - b) / j, c = j / (i < 0.5 ? e + c : 2 - e - c));
                return {h: Math.round(60 * ((6 + a) % 6)), s: Math.round(100 * c), l: Math.round(100 * i), a: this.a}
            }
            return null
        };
        this.getHSV = function () {
            if (this.c) {
                var a = this.r / 255, b = this.g / 255, d = this.b / 255, c = Math.min(a, b, d), e = Math.max(a, b, d), c = e - c;
                return {
                    h: Math.round(60 *
                        ((6 + (0 === c ? 0 : a === e ? (b - d) / c : b === e ? 2 + (d - a) / c : 4 + (a - b) / c)) % 6)),
                    s: Math.round(100 * (0 === e ? 0 : c / e)),
                    v: Math.round(100 * e),
                    a: this.a
                }
            }
        ...
        this.getHex = function () {
            if (this.c) {
                var a = this.r >> 4, b = this.g >> 4, c = this.b >> 4, d = this.r & 15, e = this.g & 15, j = this.b & 15;
                return "#" + "0123456789abcdef".charAt(a) + "0123456789abcdef".charAt(d) + "0123456789abcdef".charAt(b) + "0123456789abcdef".charAt(e) + "0123456789abcdef".charAt(c) +
                    "0123456789abcdef".charAt(j)
            }
            return null
        };
        this.getInt = function (a) {
            return this.c ? k !== a ? (100 * this.a | 0) << 24 ^ this.r << 16 ^ this.g << 8 ^ this.b : (this.r << 16 ^ this.g << 8 ^ this.b) & 16777215 : null
        };
    ...
    function q(a, d) {
        var b = "";
        do if (b = i.css(a, d), "" !== b && "transparent" !== b && "rgba(0, 0, 0, 0)" !== b || i.nodeName(a, "body"))break; while (a = a.parentNode);
        "" === b && (b = i.support.rgba ? "transparent" : "backgroundColor" === d ? "white" : "black");
        return new e(b)
    }
    ...
    i.each("color,backgroundColor,borderColor,borderTopColor,borderBottomColor,borderLeftColor,borderRightColor,outlineColor".split(","), function (a, d) {
        i.cssHooks[d] = {
            set: function (a, c) {
                a.style[d] = (new e(c)).getCSS()
            }
        };
        i.fx.step[d] = function (a) {
            if (k === a.xinit) {
                if ("string" === typeof a.end && -1 !== a.end.indexOf(";")) {
                    var c,
                        h = a.end.split(";");
                    if (h.length > 2) {
                        for (c in h)h[c] = -1 === h[c].indexOf("native") ? new e(h[c]) : q(a.elem, d);
                        a.start = null;
                        a.end = h
                    } else a.start = new e(h[0]), a.end = new e(h[1])
                } else a.start = q(a.elem, d), a.end = new e(a.end);
                a.xinit = 1
            }
            c = a.start;
            var h = a.end, f = a.pos;
            if (null === c) {
                var i = f * (h.length - 1), f = f < 1 ? i | 0 : h.length - 2;
                c = h[f];
                h = h[f + 1];
                f = i - f
            }
            a.elem.style[d] = p(c.r + f * (h.r - c.r) | 0, c.g + f * (h.g - c.g) | 0, c.b + f * (h.b - c.b) | 0, c.a + f * (h.a - c.a))
        }
    });
    i(function () {
        ...
        if (!(i.support.rgba = a.backgroundColor.indexOf("rgba") > -1))p = function (a, b, c) {
            return "rgb(" + a + "," + b + "," + c + ")"
        }
    });
    i.xcolor = new function () {
        ...
        this.sepia = function (a) {
            ...
            if (a.c) {
                var d =
                    a.r, b = a.g, c = a.b;
                a.r = Math.round(d * 0.393 + b * 0.769 + c * 0.189);
                a.g = Math.round(d * 0.349 + b * 0.686 + c * 0.168);
                a.b = Math.round(d * 0.272 + b * 0.534 + c * 0.131);
                return a
            }
            return null
        };
        ...
        this.opacity = function (a, d, b) {
            a = new e(a);
            d = new e(d);
            return a.c & d.c ? (b > 1 && (b /= 100), b = Math.max(b - 1 + d.a, 0), a.r = Math.round((d.r - a.r) * b + a.r), a.g = Math.round((d.g - a.g) * b + a.g),
        ...
        this.greyfilter = function (a, d) {
            ...
            if (c.c) {
                switch (d) {
                    case 1:
                        b = 0.35 + 13 * (c.r + c.g + c.b) / 60;
                        break;
                    case 2:
                        b = (13 * (c.r + c.g + c.b) + 5355) / 60;
                        break;
                    default:
                        b = c.r * 0.3 + c.g * 0.59 + c.b * 0.11
                }
        ...
        this.webround = function (a) {
            a = new e(a);
            if (a.c) {
                if ((a.r += 51 - a.r % 51) > 255)a.r = 255;
                if ((a.g += 51 - a.g % 51) > 255)a.g = 255;
                if ((a.b += 51 - a.b % 51) > 255)a.b = 255;
                return a
            }
            return null
        };
        ...
        this.readable = function (a, d, b) {
            ...
            a = new e(a);
            b = b || 10;
            return d.c & a.c ? (a = a.r * 0.299 + a.g * 0.587 + a.b * 0.114 - d.r * 0.299 - d.g * 0.587 - d.b * 0.114, !(a < 1.5 + 141.162 * Math.pow(0.975, b) && a > -0.5 - 154.709 * Math.pow(0.99, b))) : null
        };
        ...
        this.breed = function (a, d) {
            var b = new e(a), c = new e(d), h = 0, f = 6;
            if (b.c & c.c) {
                for (; f--;)Math.random() < 0.5 && (h |= 15 << (f << 2));
                b.r = b.r &
                    h >> 16 & 255 | c.r & (h >> 16 & 255 ^ 255);
                b.g = b.g & h >> 8 & 255 | c.g & (h >> 8 & 255 ^ 255);
                b.b = b.b & h >> 0 & 255 | c.b & (h >> 0 & 255 ^ 255);
                return b
            }
            return null
        };
        this.additive = function (a, d) {
            var b = new e(a), c = new e(d);
            if (b.c & c.c) {
                if ((b.r += c.r) > 255)b.r = 255;
                if ((b.g += c.g) > 255)b.g = 255;
                if ((b.b += c.b) > 255)b.b = 255;
                return b
            }
            return null
        };
        this.subtractive = function (a, d) {
            var b = new e(a), c = new e(d);
            if (b.c & c.c) {
                if ((b.r += c.r - 255) < 0)b.r = 0;
                if ((b.g += c.g - 255) < 0)b.g = 0;
                if ((b.b += c.b - 255) < 0)b.b = 0;
                return b
            }
            return null
        };
        ...
        this.gradientarray = function (a, d, b) {
            if (d > b)return null;
            var c = d * (a.length - 1) / b | 0, d = (d - b * c / (a.length - 1)) / b, b = new e(a[c]), c = new e(a[c + 1]);
            return b.c & c.c ? (b.r = b.r + a.length * (c.r - b.r) * d | 0, b.g = b.g + a.length * (c.g - b.g) * d | 0, b.b = b.b + a.length * (c.b - b.b) * d | 0, b) : null
        };
        this.nearestname =
            function (a) {
                a = new e(a);
        ...
        this.darken = function (a, d, b) {
            if (k === d)d = 1; else if (d < 0)return this.lighten(a, -d, b);
            k === b && (b = 32);
            a = new e(a);
            if (a.c) {
                if ((a.r -= b * d) < 0)a.r = 0;
        ...
        this.lighten = function (a, d, b) {
            if (k === d)d = 1; else if (d < 0)return this.darken(a, -d, b);
            k === b && (b = 32);
            a = new e(a);
            if (a.c) {
                if ((a.r += b * d) > 255)a.r = 255;
                if ((a.g += b * d) > 255)a.g = 255;
                if ((a.b += b * d) > 255)a.b = 255;
                return a
            }
            return null
        };
        ...
        this.monochromatic = function (a, d) {
            ...
            if (b.c) {
                for (var c = b.getHSV(), b = [b]; --d;)c.v +=
                    20, c.v %= 100, b.push(new e(c));
                return b
            }
            return null
        }
    };
    i.fn.readable = function () {
        var a = this[0], d = "", b = "";
        do {
            if ("" === d && ("transparent" === (d = i.css(a, "color")) || "rgba(0, 0, 0, 0)" === d))d = "";
            if ("" === b && ("transparent" === (b = i.css(a, "backgroundColor")) || "rgba(0, 0, 0, 0)" === b))b = "";
            if ("" !== d && "" !== b || i.nodeName(a, "body"))break
        } while (a = a.parentNode);
        "" === d && (d = "black");
        "" === b && (b = "white");
        return i.xcolor.readable(b, d)
    };
    i.fn.colorize = function (a, d, b) {
        var c = {
        ...
        if ("function" !== typeof b)if (void 0 === c[b])return; else b = c[b];
        a = new e(a);
        d = new e(d);
        this.each(function () {
            var c = this.childNodes, e = 0, i = 0;
            if (a.c & d.c) {
                for (var k = c.length; k--; e += c[k].textContent.length);
                (function j(c) {
                    var h = 0, k;
                    if (3 === c.nodeType) {
                        var l = a, r = d, o = e, s, t, n = 0, u, q = b;
                        k = c.nodeValue.length;
                        t = document.createElement("span");
                        for (h = 0; h < k; ++h)s = document.createElement("span"), u = c.nodeValue.charAt(h), n = q(i, o, n, u), s.style.color =
                            p(l.r + n * (r.r - l.r) | 0, l.g + n * (r.g - l.g) | 0, l.b + n * (r.b - l.b) | 0, l.a + n * (r.a - l.a)), s.appendChild(document.createTextNode(u)), t.appendChild(s), ++i;
...
!function ($) {
    ...
    $.fn.markdown.defaults = {
        autofocus: false, hideable: false, savable: false, width: 'inherit', height: 'inherit', buttons: [[{
            name: 'groupFont', data: [{
        ...
        }]], additionalButtons: [], onShow: function (e) {
    ...
    f.fn[n] = function (a, c) {
        ...
        if ("object" == typeof a || !a) {
            var g = f.extend({
                ...
                labelHover: !0
            }, a), h = g.handle, m = g.hoverClass || "hover", y = g.focusClass || "focus", v = g.activeClass || "active", z = !!g.labelHover, s = g.labelHoverClass || "hover", B = ("" + g.increaseArea).replace("%", "") | 0;
            ...
            return b.each(function () {
                ...
                var a = f(this), b = this, c = b.id, d =
                    ...
                    border: 0,
                    opacity: 0
                }, d = G ? {position: "absolute", visibility: "hidden"} : B ? e : {
                    position: "absolute",
                    opacity: 0
                }, h = "checkbox" == b[l] ? g.checkboxClass || "icheckbox" : g.radioClass || "i" + x, k = f(D + '[for="' + c + '"]').add(a.closest(D)), q = a.wrap('<div class="' + h + '"/>')[r]("ifCreated").parent().append(g.insert), e = f('<ins class="' + F + '"/>').css(e).appendTo(q);
                ...
                switch (options.placement) {
                    ...
                    case 'left':
                        maxLengthIndicator.css({
                            top: top + pos.height / 2 - actualHeight / 2,
                    ...
                    case 'centered-right':
                        maxLengthIndicator.css({
                            ...
                            left: left + inputOuter - outerWidth - 3
                        });
                        break;
                }
            }
...
!function () {
    ...
    this.Draggable = function () {
        ...
        oninit: function () {
            ...
            var e = this;
            this.supportTouches_ = t.browser.webkit && -1 != navigator.userAgent.indexOf("Mobile"), this.events_ = {
                click: this.supportTouches_ ? "touchstart" : "click",
                down: this.supportTouches_ ? "touchstart" : "mousedown",
                move: this.supportTouches_ ? "touchmove" : "mousemove",
                up: this.supportTouches_ ? "touchend" : "mouseup"
            }, this._bindEvent(t(document), "move", function (t) {
            ...
            this.cx = s.x - i.left, this.cy = s.y - i.top, t.extend(this.d, {
                left: i.left,
                top: i.top,
                width: this.ptr.width(),
                height: this.ptr.height()
            }), this.outer && this.outer.get(0) && this.outer.css({
                height: Math.max(this.outer.height(), t(document.body).height()),
                overflow: "hidden"
            }), this.onmousedown(e)
    ...
    var i = {
        settings: {from: 1, to: 10, step: 1, smooth: !0, limits: !0, round: 0, value: "5;7", dimension: ""},
        className: "jslider",
        selector: ".jslider-",
    ...
    this.jSlider = function () {
        ...
        init: function (e, s) {
            ...
            this.domNode = t(i.template({
                ...
                pointers: {},
                labels: {
                    0: {o: this.domNode.find(i.selector + "value").not(i.selector + "value-to")},
                    1: {o: this.domNode.find(i.selector + "value").filter(i.selector + "value-to")}
                },
                limits: {
                    0: this.domNode.find(i.selector + "label").not(i.selector + "label-to"),
                    1: this.domNode.find(i.selector + "label").filter(i.selector + "label-to")
                }
            }), t.extend(this.o.labels[0], {value: this.o.labels[0].o.find("span")}), t.extend(this.o.labels[1], {value: this.o.labels[1].o.find("span")}), s.settings.value.split(";")[1] || (this.settings.single = !0, this.domNode.addDependClass("single")), s.settings.limits || this.domNode.addDependClass("limitless"), this.domNode.find(i.selector + "pointer").each(function (t) {
            ...
            this.sizes = {
                domWidth: this.domNode.width(),
                domOffset: this.domNode.offset()
            }, t.each(this.o.pointers, function () {
                e.redraw(this)
            })
        }, limits: function (t, e) {
            ...
            return this.is.init ? (this.setValue(), this.o.pointers[0] && this.o.pointers[1] && this.o.value.css({
                left: this.o.pointers[0].value.prc + "%",
                width: this.o.pointers[1].value.prc - this.o.pointers[0].value.prc + "%"
            }), this.o.labels[t.uid].value.html(this.nice(t.value.origin)), this.redrawLabels(t), void 0) : !1
        }, redrawLabels: function (t) {
            function e(t, e, s) {
                return e.margin = -e.label / 2, label_left = e.border + e.margin, 0 > label_left && (e.margin -= label_left), e.border + e.label / 2 > i.sizes.domWidth ? (e.margin = 0, e.right = !0) : e.right = !1, t.o.css({
                    left: s + "%",
                    marginLeft: e.margin,
                    right: "auto"
                }), e.right && t.o.css({left: "auto", right: 0}), e
            }

            var i = this, s = this.o.labels[t.uid], n = t.value.prc, o = {
                label: s.o.outerWidth(),
                right: !1,
                border: n * this.sizes.domWidth / 100
            };
...
!function (t) {
    ...
    t.Slider = function (t, i) {
        ...
        _create: function () {
            this.slider = this.$el.slider({
                ...
                max: this.total,
                step: 1
            }), this.$value = t("<span>" + this.value + "</span>"), this.getHandle().append(this.$value)
        }, setValue: function (t) {
    ...
    }, t.Pagination.defaults = {
        value: 1, total: 5, width: 200, onChange: function () {
            return !1
        }, onSlide: function () {
            return !1
        }
    }, t.Pagination.prototype = {
        _init: function (i) {
            ...
            this.slider = new t.Slider({
                range: this.options.range,
                value: this.options.value,
                total: this.options.total,
                width: this.options.width
            }, i), this.isSliderOpened = this.options.sliderOpened
 ...
 */
(function (p) {
    var g = p.document, e = Math, l = "getContext" in g.createElement("canvas"), h = function (d, a) {
        d = d || {};
    ...
    Throbber = function (d) {
        var a = this.elem = g.createElement("canvas"), c = this;
        isNaN(d) || (d = {size: d});
        this.o = {size: 34, rotationspeed: 6, clockwise: !0, color: "#fff", fade: 300, fallback: !1, alpha: 1};
        this.configure(d);
        this.phase = -1;
        l ? (this.ctx = a.getContext("2d"), a.width = a.height = this.o.size) : this.o.fallback && (a = this.elem =
            new Image, a.src = this.o.fallback);
        this.loop = function () {
            var b = c.o, d = 0, g = 1E3 / b.fade / b.fps, n = c.step, h = a.style, v = "filter" in h && b.fallback && !l;
            return function () {
                3 == c.phase && (d -= g, 0 >= d && (c.phase = 0));
                1 == c.phase && (d += g, 1 <= d && (c.phase = 2));
                if (v)h.filter = "alpha(opacity=" + e.min(100 * b.alpha, e.max(0, Math.round(100 * d))) + ")"; else if (!l && b.fallback)h.opacity = d; else if (l) {
                    var a = c.ctx, s = n;
                    t = 1 - d || 0;
                    q = 1;
                    r = -1;
                    var f = b.size;
                    !1 === b.clockwise && (q = -1, r = 1);
                    a.clearRect(0, 0, f, f);
                    a.globalAlpha = b.alpha;
                    a.lineWidth = b.strokewidth;
                    for (k = 0; k < b.lines; k++)u = k + s >= b.lines ? k - b.lines + s : k + s, a.strokeStyle = "rgba(" + b.color.join(",") + "," + e.max(0, u / b.lines - t) + ")", a.beginPath(), a.moveTo(f / 2, f / 2 - b.padding / 2), a.lineTo(f / 2, 0), a.stroke(b.strokewidth), m(a, f, !1), a.rotate(q * (360 / b.lines) * e.PI / 180), m(a, f, !0);
                    b.rotationspeed && (a.save(), m(a, f, !1), a.rotate(r * (360 / b.lines / (20 - 2 * b.rotationspeed)) * e.PI / 180), m(a, f, !0));
                    n = 0 === n ? c.o.lines : n - 1
                }
                p.setTimeout(c.loop, 1E3 / b.fps)
            }
        }()
    };
    Throbber.prototype = {
        constructor: Throbber, appendTo: function (d) {
            ...
            h(b, d || {});
            a = b.color;
            l ? (c = g.createElement("i"), c.style.display = "none", c.style.color = a, g.body.appendChild(c), a = p.getComputedStyle(c, null).getPropertyValue("color").replace(/^rgba?\(([^\)]+)\)/, "$1").replace(/\s/g, "").split(",").splice(0, 4), g.body.removeChild(c), c = 4 == a.length ? a.pop() : 1) : (a = !1, c = 1);
            h(b, h({
                padding: b.size / 2,
                strokewidth: e.max(1, e.min(b.size / 30, 3)),
                lines: e.min(30, b.size / 2 + 4),
                alpha: c || 1,
                fps: e.min(30, b.size +
                    4)
            }, d));
            ...
            2 == this.phase ? this.stop() : this.start()
        }
    }
})(this);